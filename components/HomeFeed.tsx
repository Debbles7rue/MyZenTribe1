...
export default function HomeFeed() {
  ...
  return (
    <>
      ...
      {/* Fixed Bottom Navigation Bar - All 4 items, hide on desktop */}
      ...
      {/* SOS Button - positioned to not overlap bottom nav on mobile */}
      <div className="fixed bottom-20 right-4 sm:bottom-4 z-30">
        <SOSFloatingButton />
      </div>
    </>
  );
