    ...
    <div className="home-feed">
      ...
      <div className="action-buttons-section">
        <div className="action-buttons-card">
          <h3 className="action-buttons-title">Connect & Support</h3>
          
          <div className="action-buttons-grid">
            <a href="/contact" className="action-button contact-btn">
              <span className="action-icon">💬</span>
              <span className="action-label">Contact</span>
            </a>
            
            <a href="/suggestions" className="action-button suggestions-btn">
              <span className="action-icon">💡</span>
              <span className="action-label">Ideas</span>
            </a>
            
            <a href="/donate" className="action-button donate-btn">
              <span className="action-icon">💝</span>
