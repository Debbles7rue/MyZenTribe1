      ...
      <div className="max-w-[1600px] mx-auto px-3 sm:px-6">
        ...
        {isMobile ? (
          <div className="flex items-center justify-between py-3">
            ...
            {/* Center: Mode Switcher - MADE TWICE AS BIG */}
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="p-3 rounded-lg bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200 transition-all duration-200"
                title="Extras & Tools"
              >
