        ...
        {isMobile ? (
              ...
              {listsDropdownOpen && (
                <div className="absolute top-full left-0 mt-2 w-80 bg-white dark:bg-gray-800 rounded-xl shadow-xl border border-gray-200 dark:border-gray-700 z-50">
                  ...
                  <div className="flex border-b dark:border-gray-700">
                    ...
                    >
                      Todos {todosCount > 0 && <span className="ml-1 bg-purple-100 dark:bg-purple-900 text-purple-600 dark:text-purple-400 px-2 py-0.5 rounded-full text-xs">{todosCount}</span>}
                    </button>
                    <button
                    ...
                    >
                      Reminders {remindersCount > 0 && <span className="ml-1 bg-blue-100 dark:bg-blue-900 text-blue-600 dark:text-blue-400 px-2 py-0.5 rounded-full text-xs">{remindersCount}</span>}
                    </button>
                    <button
                    ...
                    >
                      Shopping {shoppingCount > 0 && <span className="ml-1 bg-green-100 dark:bg-green-900 text-green-600 dark:text-green-400 px-2 py-0.5 rounded-full text-xs">{shoppingCount}</span>}
                    </button>
                  </div>
          ...
          <div className="flex items-center justify-between py-4">
                    ...
                    {getCurrentListItems().length > 0 ? (
                      getCurrentListItems().map((item) => (
                        <div
                          ...
                          draggable
                          onDragStart={() => handleDragStart(item)}
                          className="flex items-center gap-3 p-3 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 cursor-grab active:cursor-grabbing transition-colors mb-2"
                        >
                          <span className="text-lg">{getItemIcon(item.type)}</span>
                          <div className="flex-1 min-w-0">
                            <p className="text-sm font-medium text-gray-900 dark:text-white truncate">
            ...
            <div className="flex items-center gap-3">
              <button
                onClick={() => router.push('/calendar/tools')}
                className="px-4 py-2 bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 rounded-lg font-medium hover:bg-gray-200 dark:hover:bg-gray-700 transition-all duration-200 flex items-center gap-2"
              >
