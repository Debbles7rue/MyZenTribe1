...
export default function CalendarModals({
  ...
  return (
    <>
      ...
      {/* Time Blocking Modal - Now using separate component */}
      {showTimeBlocking && (
        <TimeBlockScheduler
          ...
          onSchedule={(blockData) => {
            setForm(prev => ({
              ...
              background_color: blockData.color
            }));
      ...
      <EventCarpoolModal
        ...
        showToast={showToast}
        isMobile={isMobile}
        onOpenSettings={onOpenCarpoolSettings}
      />
