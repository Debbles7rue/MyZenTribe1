...
import { supabase } from "@/lib/supabaseClient";// app/profile/page.tsx
"use client";
...
export default function ProfilePage() {
  ...
  return (
    <div className="profile-page">
      ...
      {/* Sacred Candles Widget - Only render when userId is available */}
      ...
      {/* Photos Feed - Only render when userId is available */}
