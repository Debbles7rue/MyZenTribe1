    ...
    <div className="grid md:grid-cols-2 gap-10 items-center">
      <MotionDiv className="space-y-6">
        ...
        <div className="flex gap-3">
          <Link href="/events" className="px-4 py-2 rounded-2xl bg-brand-500 text-white shadow">
            Explore Events
          </Link>
      ...
      <MotionDiv className="rounded-2xl p-6 border bg-white/70 dark:bg-zinc-900/50 shadow-lg">
